...
const PeaceMatchMap = () => {
  ...
  // Google Maps container style with fixed height so it displays properly
  ...
  const { isLoaded, loadError } = useJsApiLoader({
    googleMapsApiKey: 'AIzaSyDm4GUFoFKa71UZhhZBsmdKvcXCgXrEdI0',
  });
